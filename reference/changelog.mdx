...
<Card title="GitHub Releases" icon="github" href="https://github.com/yourusername/pm-auto/releases">
...
<Note>
  Feature requests and suggestions are welcome on [GitHub Issues](https://github.com/yourusername/pm-auto/issues).
</Note>
...
<Accordion title="View older versions">
  Detailed changelogs for versions prior to 1.0.8 are available on the [GitHub Releases page](https://github.com/yourusername/pm-auto/releases).
